// 该js文件将从命令行里传入的args字符串通过eP将其转化成params里所需要的sign
let eP = function (eu) {
    function ep(eu, ep) {
    ...
    var eC, eO, eA, eN, eL, eR, eD, eB, eU, eF = [], ez = 7, eV = 12, eW = 17, eH = 22, eG = 5, eZ = 9, eX = 14,
        eJ = 20, eY = 4, eK = 11, eQ = 16, e$ = 23, e0 = 6, e3 = 10, e4 = 15, e5 = 21;
    for (eF = function (eu) {
